                            ...
                            <div className="col-md-6">
                                <div className="invoice-info">
                                    ...
                                    <p className="invoice-details invoice-details-two">
                                        ...
                                        {data?.appointment?.doctor?.address ? data?.appointment?.doctor?.address : "8876 Mission Blvd, Jurupa Valley, CA 92509"}, {data?.appointment?.doctor?.city && data?.appointment?.doctor?.city},<br />
